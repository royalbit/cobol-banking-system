# Contributing to COBOL Banking System

This project uses the **RoyalBit Asimov AI-Only Development Model** ([ADR-011](https://github.com/royalbit/asimov-protocol/blob/main/docs/adr/011-ai-only-development-no-external-prs.md)).
...
Forks are encouraged! See the [RoyalBit Asimov](https://github.com/royalbit/asimov-protocol) for details.
